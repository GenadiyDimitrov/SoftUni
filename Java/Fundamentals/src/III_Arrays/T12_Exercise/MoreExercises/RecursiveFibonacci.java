...
//TODO recursive!!! 100/100 BUT NOT THE SOLUTION WE ARE LOOKING FOR
...
Therefor the sequence goes like 1, 1, 2, 3, 5, 8, 13, 21, 34…
...
public class RecursiveFibonacci {
    public static void main(String[] args) {
        ...
        //region Not Recursive
        //set number two positions back
        int secondPrevNumber = 0;
        //set number one position back
        int prevNumber = 1;
        //loop until N
        for (int i = 1; i < n; i++) {
            //calculate current position
            int current = prevNumber + secondPrevNumber;
            //set number two positions back
